...
# Setup PYTHONPATH to not break imports of 
# the code of the project
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
sys.path.insert(0, BASE_DIR)


# Load DATABASE_URL env variable
env_path = Path(__file__).resolve().parent / "alembic_env"
...
###### SETUP ########
# Add future models here. Does not matter 
# if they are not referenced in the code
